            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('superadmin.disputes.index') }}" class="btn btn-sm btn-outline-primary">View All</a>
                    </div>
                </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $dispute->status == 'pending' ? 'warning' : ($dispute->status == 'resolved' ? 'success' : 'info') }}">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('superadmin.agencies.index') }}" class="btn btn-sm btn-outline-primary">View All</a>
                    </div>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                                ...
                                <tr>
                                    <td class="px-4">
                                        <div class="d-flex align-items-center gap-2">
                                            @if($agency->logo)
                                                <img src="{{ asset('storage/' . $agency->logo) }}" alt="{{ $agency->name }}" class="rounded" style="width: 30px; height: 30px; object-fit: cover;">
                                            @else
                                                <div class="bg-primary text-white rounded d-flex align-items-center justify-center" style="width: 30px; height: 30px; font-size: 0.8rem; font-weight: bold;">
